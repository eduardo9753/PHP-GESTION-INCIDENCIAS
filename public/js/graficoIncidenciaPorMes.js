window.addEventListener('DOMContentLoaded', () => {
    ...
    const txt_count_incidencia_cerrado = document.querySelector('#txt_count_incidencia_cerrado').value;
    const txt_count_incidencia_pendiente = document.querySelector('#txt_count_incidencia_pendiente').value;
    
    const txt_count_reclamos_cerrado = document.querySelector('#txt_count_reclamos_cerrado').value;
    const txt_count_reclamos_pendiente = document.querySelector('#txt_count_reclamos_pendiente').value;
