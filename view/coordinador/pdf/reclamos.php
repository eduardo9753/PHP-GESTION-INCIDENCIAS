...
$pdf->Multicell(190,4.5, utf8_decode(wordwrap($dataIncidenciaPDF->detalle, 125, "\n")), 1, 1);
$pdf->Ln(8);
...
$pdf->Multicell(190,4.5, utf8_decode(wordwrap($dataIncidenciaPDF->accion_inmediata, 125, "\n")), 1, 1);
$pdf->Ln(8);
