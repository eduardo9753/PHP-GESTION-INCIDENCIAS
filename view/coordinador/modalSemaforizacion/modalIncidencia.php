<button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#boxEditarIncidencia_<?php echo $data->id ?>">
    <i class='bx bx-edit bx-tada'></i>
</button>

<!--LLAVE DEL MODAL-->
<div class="modal fade" id="boxEditarIncidencia_<?php echo $data->id ?>" tabindex="-1" aria-labelledby="boxEditarIncidencia_" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="boxEditarIncidencia_"><?php echo $data->tipo_semaforizacion ?> | PACIENTE: <?php echo $data->paciente ?></h5>
            ...
            <div class="modal-body">
                <div class="card-body">
                    ...
                    <form action="ActualizarIncidencia" id="frmSemaforizacionEditar_<?php echo $data->id ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mx-auto"><button type="submit" class="btn btn-primary w-100" name="btn-update-incidencia-Editar" id="btn-update-incidencia-Editar">Actulizar Datos<i class='bx bxs-right-arrow bx-fade-right'></i></button></div>
                        </div>
                    </form>
                    <!--end row-->
                </div>
