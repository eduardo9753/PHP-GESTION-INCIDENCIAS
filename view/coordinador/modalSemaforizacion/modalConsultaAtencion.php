<button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#boxEstadoCerradoSemaforizacion_<?php echo $data->id ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txt_conclusion" id="txt_conclusion" value="<?php echo $data->nombre_conclusion ?>" class="form-control" readonly>
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="" class="color-paus">DETALLE</label>
                                    <input type="text" name="txt_detalle" id="txt_detalle" value="<?php echo $data->detalle ?>" class="form-control" readonly>
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="" class="color-paus">ACCION INMEDIATA</label>
                                    <input type="text" name="txt_detalle" id="txt_detalle" value="<?php echo $data->accion_inmediata ?>" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    </form>
